...
check("area: type area, opacity 0.15, tooltip null, y=Plot_Actual, y2=Plot_Reference, detail=Segment_ID", area.mark.type === "area" && area.mark.opacity === 0.15 && area.mark.tooltip === null && area.encoding.y.field === "Plot_Actual" && area.encoding.y2.field === "Plot_Reference" && area.encoding.detail.field === "Segment_ID");
