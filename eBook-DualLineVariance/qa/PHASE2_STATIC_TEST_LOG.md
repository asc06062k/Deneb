...
| Axis label เดือนภาษาไทย (M-02 ส่วน labelExpr) | 12 label ครบ พร้อม axis title "เดือน" | ยืนยันจาก DOM: `g.role-axis-label text` = `["ม.ค.",...,"ธ.ค."]` ครบ 12, axis title = "เดือน" | PASS |
