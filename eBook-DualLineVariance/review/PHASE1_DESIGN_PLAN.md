...
**คำตัดสินผู้ใช้ (24 ก.ย. 2026)**: **ยอมรับพฤติกรรมนี้และเขียนในหนังสือ** — ไม่เปลี่ยน architecture (ไม่แบ่งพื้นที่ที่จุดกึ่งกลาง segment และไม่พยายามปิดการคลิกพื้นที่สี) บทที่ 8 ต้อง: (1) สอนให้คลิกที่**จุดข้อมูล**เป็นวิธีหลักในการเลือกเดือน (2) อธิบายตรงไปตรงมาว่าคลิกพื้นที่สีถูกออกแบบให้เลือก "เดือนต้นช่วง" ของช่วงนั้น พร้อมภาพประกอบ (3) ระบุเป็นข้อจำกัดเทียบกับต้นแบบ — **Phase 2 ข้อ 7 ยังไม่ผ่าน gate**: Case C (T18-06) และ T22 หลังล้าง selection (T22-05) ทดสอบแล้ว; รอ Evidence record ครบ (version, PBIX, viewport, ภาพ T18(ก))
