...
Layer สองเส้น, สี/lineStyle ต่อ series, จุดข้อมูล (point mark), Sort ตาม Category, เส้นโค้ง `monotone` (พร้อมกล่อง Known limitation M-11), แกน Y อัตโนมัติ ±18% แบบต้นแบบ (`params` + `scale.domain`)
